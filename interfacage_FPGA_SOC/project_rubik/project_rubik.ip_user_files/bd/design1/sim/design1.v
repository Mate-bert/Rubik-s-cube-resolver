...
module design1
  ...
  wire memory_reader_0_bram_en;
  wire memory_reader_0_bram_rst;
  ...
  (* KEEP_HIERARCHY = "yes" *) 
  design1_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  design1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(memory_reader_0_bram_addr),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(memory_reader_0_bram_clk),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(memory_reader_0_bram_dout),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(blk_mem_gen_0_doutb),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(memory_reader_0_bram_en),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(memory_reader_0_bram_rst),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(memory_reader_0_bram_we));
  design1_memory_reader_0_0 memory_reader_0
       (.bram_addr(memory_reader_0_bram_addr),
        .bram_clk(memory_reader_0_bram_clk),
        .bram_din(blk_mem_gen_0_doutb),
        .bram_dout(memory_reader_0_bram_dout),
        .bram_en(memory_reader_0_bram_en),
  ...
  design1_rubik_resolver_0_0 rubik_resolver_0
       (.i_clk(processing_system7_0_FCLK_CLK0),
